...
public class LevelLoader : MonoBehaviour
{
    ...
    private bool alreadyClickedInMenu;
    ...
    public void StartofNewScene(){
        ...
        if (currentGameScene.buildIndex == 0 || !_controls.TitleScreen.enabled || currentGameScene.name == "AScene 0 - Title Screen")
        {
    ...
    private void Update()
    {
        ...
        if (userInput.titleScreenControlsActive && !alreadyClickedInMenu)
        {
            ...
            // }
            if (UserInput.AnyKeyOrStart || UserInput.QuitGame)
            {
                ClickAnywhereHandler.Instance?.ShowPlayButtons();
                alreadyClickedInMenu = true;
            }
        }
    }
